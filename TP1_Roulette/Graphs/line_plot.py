...
def plot_graph(multi_metrics_arrays, n_iters, num, expected_values, file_out):
    ...
    specific_plot_generator = general_generate_subplot(
        figure=fig, x_axis=x, n_iters=n_iters
    )
    ...
    specific_plot_generator(
        ...
        params=Params(title="Mean", xlabel="Iteration Number (n)", position=2),
    )
    ...
    specific_plot_generator(
        ...
        params=Params(
            title="Standard Deviation", xlabel="Iteration Number (n)", position=3
        ),
    )
    ...
    specific_plot_generator(
        ...
        params=Params(title="Variance", xlabel="Iteration Number (n)", position=4),
    )
